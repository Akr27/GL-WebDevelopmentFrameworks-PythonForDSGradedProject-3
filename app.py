...
ENV = 'dev'
app.debug = True
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql://root:admin@localhost:3306/greatlearningdb'
...
# To manage our application and Flask_login to work together
    ...
    def validate_username(self, username):
        ...
        if existing_user_username:
            raise ValidationError(
                'The username provided already exists! Please choose a different one.')
